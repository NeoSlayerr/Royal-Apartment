            ...
            <div class="container text-center border-1" style="height:20%; border-color:blue;">
                ...
                <div class="accordion-item">
                    ...
                    <div class="col mt-4 mb-4 ms-5" style="width:10%" >
                        <a class="btn text-white" style="background-color:#E0B973; float:right; margin-right:30px;" href="<?php echo base_url()?>Welcome/booking"><?php echo $p1;?>/year</a>
                    </div>
                    </h2>
        ...
        <div class="mt-5">
            ...
            <div class="container text-center border-1" style="height:20%; border-color:blue;">
                ...
                <div class="accordion-item">
                    ...
                    <div class="col mt-4 mb-4 ms-5" style="width:10%" >
                        <a class="btn text-white" style="background-color:#E0B973; float:right; margin-right:30px;" href="<?php echo base_url()?>Welcome/booking"><?php echo $p2;?>/year</a>
                    </div>
                    </h2>
        ...
        <div class="mt-5">
            ...
            <div class="container text-center border-1" style="height:20%; border-color:blue;">
                ...
                <div class="accordion-item">
                    ...
                    <div class="col mt-4 mb-4 ms-5" style="width:10%" >
                        <a class="btn text-white" style="background-color:#E0B973; float:right; margin-right:30px;" href="<?php echo base_url()?>Welcome/booking"><?php echo $p3;?>/year</a>
                    </div>
                    </h2>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6" style="width:80%;">
                                        <h5 class="font" style="padding-top:20px; float:left; padding-left:15px;">5<?php echo $bedroom3;?> Bedroom</h5>
                                    </div>
                                </div>
